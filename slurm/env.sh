...
# Load env
module load conda
mamba env create -f /blue/prismap-ai-core/sasank.desaraju/projects/lightning-hydra-template/environment.yaml
# conda activate mlenv

# HPG actually recommends prepending the path to the environment instead of loading it.
# export PATH=/home/sasank.desaraju.conda/envs/llm/bin:$PATH
# export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/sasank.desaraju.conda/envs/llm/bin
